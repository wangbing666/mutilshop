                ...
                <div className="centerStyle">
                    ...
                    <div className="divP">
                        ...
                        (userImgList.length==0
                            ...
                            <span>还剩{expiredPeople}个名额，<span
                            className="spanTime"
                            style={ {color: this.colorDic['COLOR1']}}>{this.state.expiredTime}</span>后结束</span> )
                            :
                            null
                        }
                        {groupText === '拼团成功' ? <span>用时<span
                            className="spanTime" style={{color: this.colorDic['COLOR1']}}>{this.formatSeconds(groupSucess.usedTime)}</span>，打败{groupSucess.beatPeopleNum}的人</span> : null}
        ...
        <div>
            ...
            <div className="centerStyle">
                ...
                <div className="divP">
                    ...
                    <span
                        className="spanTime"
                        style={ {color: this.colorDic['COLOR1']}}>{this.state.expiredTime}</span><span>后结束 </span >
                    </div >
