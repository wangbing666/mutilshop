...
class logisticsDetail extends React.Component {
    ...
    componentWillMount() {
       ...
       // console.log(this.theRequest,"11222222222");
    ...
    componentDidMount() {
        ...
        this.state.totalNum = query.totalNum;//商品数量
        this.state.pictureUrl = query.url;//图片url
        let status = query.status;//订单是否已收货
        let orderId = query.orderId;//订单号
     
        this.state.deliverCompanyName = query.deliverCompanyName;//物流公司
        let deliverCompanyNo = query.deliverCompanyNo;//物流公司对应码
        this.state.transportNo = query.transportNo;//运单编号
        // if (status != 4) {
