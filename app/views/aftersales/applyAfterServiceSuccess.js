...
class applyAfterSalesServiceSuccess extends React.Component {
    ...
    render() {
        return (
            <div className='text5' style={{height:this.height}}>
                <img className='img5'
...
export default withRouter(applyAfterSalesServiceSuccess)