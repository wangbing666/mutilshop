...
export default class PPStoryDetailsBuyerManage extends Component{
        ...
        PPStoryDetailsAction.getStoryDetailsPost(dicData,(callBack)=>{
            ...
            if (callBack){
                ...
                let storyDic = {
                    ...
                    enterpriseId:'0',
                    url:(contants.commonServerUrl + '/storyDetailsBuyerManages' + '/?storyId=' + this.state.storyId + '&shopId=' + this.state.shopId).toString(),
                    shareType:'12',
                    sourceType:'1',
    ...
    payAction(goodsId){
        ...
        history.push({
            pathname:contants.commonUrl+'/goodDetails'+'/?shopId='+this.state.shopId+'&goodsId='+goodsId//PPShoppingCart
        });
