...
export default class GroupShoppingDetail extends Component {
        ...
        groupDetailsActions.getGroupDetailDataFromSever('/groupActBuy/getGroupActBuyDetail', wedoId, this.state.orderSonId, (response) => {
            ...
            if (response.body.goodsActDetail != null) {
                ...
                let dic = {
                    ...
                    imgUrl: goodsActDetail.goodsUrl,
                    linkUrl: constants.commonServerUrl + '/groupShoppingDetail' + '/?shopId=' + this.state.shopId + '&orderId=' + this.state.orderId + '&orderSonId=' + this.state.orderSonId//goodsUrl + '&goodsId=' + goodsActDetail.goodsId
                };
                wxShare([], dic, true);
                //二维码URL
                this.setState({
    ...
    showBottomDiv(groupStatus, groupDetailData, isAttend) {
        if (groupStatus === 0) {
            return (<div>
                    {isAttend ?  <div className="bottomStyle">
                            <div className="mulitP">恭喜！拼团成功！</div>
                            <button className="invateBtn"
        ...
        return (
            <div className="container">
                {groupDetailData ? <div>
                    ...
                    />
                    {this.showBottomDiv(groupStatus, groupDetailData, isAttend)}
    ...
    qrCodePress(groupStatus, groupDetailData) {
        if (groupStatus === 1) {
            ...
            if (this.state.QRUrl === '') {
                this.setState({
                    QRUrl: constants.commonServerUrlRetail + '/goodDetails' + '/?shopId=' + this.state.shopId + '&goodsId=' + groupDetailData.goodsId + '&groupId=' + groupDetailData.groupBuyId
                })
            }
