    ...
    choose(i,j){
        ...
        indexArr.map((val,m)=>{
            if(val){
                ...
                if((goodInfo.goodsruleslist[m1].havaFile>0) && m1==i && m2==j){
                        try {
                            this.setState({
                        ...
                        <header className='goodDialog'>
                            ...
                            {groupG
                                ...
                                <div className='goodDialogHeader'>
                                    ...
                                    <div className="ggoodsPrice"><p>商品售价:</p><p>￥{this.state.price?this.state.price:groupInf.price}</p></div>
                                    <div className="ggoodsProfit"><p>利润:</p><p>￥{this.state.shareProfit?this.state.shareProfit:groupInf.shareProfit}</p></div>
